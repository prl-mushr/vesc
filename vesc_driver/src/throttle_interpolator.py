...
class InterpolateThrottle:
    def __init__(self):
        ...
        self.throttle_smoother_rate = rospy.get_param(rospy.search_param('throttle_smoother_rate'))
        self.speed_to_erpm_gain = rospy.get_param(rospy.search_param('speed_to_erpm_gain'))

        self.max_servo_speed = rospy.get_param(rospy.search_param('max_servo_speed'))
        self.steering_angle_to_servo_gain = rospy.get_param(rospy.search_param('steering_angle_to_servo_gain'))
        self.servo_smoother_rate = rospy.get_param(rospy.search_param('servo_smoother_rate'))
        ...
        self.last_servo = rospy.get_param(rospy.search_param('steering_angle_to_servo_offset'))
